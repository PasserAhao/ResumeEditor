        ...
        <div style="overflow: hidden">
          ...
          <div v-for="(item,index) in ModuleList" :key="index" style="font-size: 14px">
            <div v-if="item.isShow">
              ...
              <!--      自定义模块内容           -->
              <ModuleContent :colors-config="colorsConfig" :module-content="ModuleList"/>
            </div>
...
export default defineComponent({
  ...
  components: {
    ...
    Star, MedalOne, SeoFolder, Briefcase, BachelorCapOne, MdEditor, ResumeEditor, AvatarTem, ModuleContent
  },
  setup() {
