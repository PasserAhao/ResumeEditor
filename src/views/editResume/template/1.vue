  ...
  setup() {
    ...
    const baseInfo = () => {
      ...
      const userinfo = reactive({
        ...
        jobIntention: [
          {index: 1, isShow: true, title: "求职意向", content: ""},
          {index: 2, isShow: true, title: "意向城市", content: ""},
          {index: 3, isShow: true, title: "期望薪资", content: ""},
          {index: 4, isShow: true, title: "到岗时间", content: ""},
        ]
      })
      const workerAge = ref([
